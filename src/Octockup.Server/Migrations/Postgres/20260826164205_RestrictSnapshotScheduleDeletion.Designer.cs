...
namespace Octockup.Server.Migrations.Postgres
{
    ...
    [Migration("20260826164205_RestrictSnapshotScheduleDeletion")]
    partial class RestrictSnapshotScheduleDeletion
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Octockup.Server.Database.Snapshot", b =>
                {
                    ...
                    b.HasOne("Octockup.Server.Database.Schedule", "Schedule")
                        .WithMany("Snapshots")
