...
namespace Octockup.Server.Migrations.PostgresMigrations
{
    ...
    [Migration("20250105111952_AddStrictMode")]
    partial class AddStrictMode
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Octockup.Server.Database.SavedFile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<int>("BackupSnapshotId")
                        .HasColumnType("integer")
                        .HasColumnName("backup_snapshot_id");
                    ...
                    b.Property<DateTime>("MetadataCreatedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("metadata_created_at");

                    b.Property<DateTime>("MetadataUpdatedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("metadata_updated_at");
                    ...
                    b.HasIndex("BackupSnapshotId");

                    b.ToTable("saved_files");
                });
            ...
            modelBuilder.Entity("Octockup.Server.Database.SavedFile", b =>
                {
                    b.HasOne("Octockup.Server.Database.BackupSnapshot", "BackupSnapshot")
                        .WithMany("SavedFiles")
                        .HasForeignKey("BackupSnapshotId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("BackupSnapshot");
                });
